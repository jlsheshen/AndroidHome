...
//        Log.d("AdhesionLayout", String.format("widthMeasureSpec: %s ,heightMeasureSpec %s,getx %s,gety %s" , getMeasuredWidth(),getMeasuredHeight()));
        Log.d("AdhesionLayout", "onMeasure");
...
//        Log.d("AdhesionLayout", String.format("w: %s ,h %s,oldw %s,oldh %s ,getx %s,gety %s" , w,h,oldh,oldw,getX(),getY()));

        Log.d("AdhesionLayout", "onSizeChanged");
...
//            mView = getChildAt(0);
            ...
            mX = getX();
            mY = getY();
            Log.d("AdhesionLayout", String.format("onSizeChanged  mX = %s,mY = %s",mX,mY));
...
//        Log.d("AdhesionLayout", "onTouchEvent");
        ...
        switch (event.getAction()) {
            case MotionEvent.ACTION_DOWN:
                 ...
                 */
                mHeaderCircle.x =  mHeaderCircle.x;
                mHeaderCircle.y = mHeaderCircle.y;
                mFooterCircle.x =  mFooterCircle.x;
                mFooterCircle.y =  mFooterCircle.y;
                mDownX = event.getX();
                mDownY =  event.getY();
    ...
    private void startAnim() {
        ...
        /* x方向 */
        ValueAnimator xValueAnimator = ValueAnimator.ofFloat(mFooterCircle.x,  mWidth / 2);
        ...
        /* y方向 */
        ValueAnimator yValueAnimator = ValueAnimator.ofFloat(mFooterCircle.y, mHeight / 2);
